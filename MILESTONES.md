# Milestones: Pocket Monsters Brilliant Diamond

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-BrilliantDiamond-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Brilliant Diamond |
...
Coordinate with Shining Pearl while documenting engine, managed-code, native-module, and asset boundaries from evidence.

...
Decompilation and source-reconstruction project for **Pokémon Brilliant Diamond**.

This repository is part of the **Generation VIII decompilation cohort** together with Sword, Shield, Shining Pearl, and Pokémon Legends: Arceus. Each game remains an independent reconstruction target.
...
- Preserve Brilliant Diamond-specific behavior and version-exclusive data.
- Compare with Shining Pearl and original Generation IV titles without assuming implementation identity.
...
- [ ] Verify exact Brilliant Diamond revisions/updates
